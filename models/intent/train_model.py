...
from keras.api._v2.keras.layers import Input, Embedding, Dense, Dropout, Conv1D, concatenate, GlobalMaxPool1D
...
# 모델 저장  ○8
model.save(os.path.join(cwd,'models','intent','intent_model.h5'))
